...
const faqs = [
  {
    q: "導入にどのくらい時間がかかりますか？",
    a: "ご契約から最短2週間での稼働が可能です。既存のLINE公式アカウントへの接続と初期設定をサポートスタッフが全面的にサポートします。",
  },
  {
    q: "ITに詳しくないスタッフでも使えますか？",
    a: "はい。直感的なUIで設計されており、初回の操作研修（オンライン30分）を受ければすぐに使い始めていただけます。操作でわからないことはチャットサポートでいつでも対応します。",
  },
  {
    q: "既存の予約システムと連携できますか？",
    a: "主要な歯科予約システムとのAPI連携に対応しています。対応状況についてはお問い合わせの際にご確認ください。",
  },
  {
    q: "患者の個人情報はどのように管理されますか？",
    a: "データはすべて国内サーバーで管理され、SSL通信・暗号化保存を徹底しています。個人情報保護法に準拠した運用を行っています。",
  },
  {
    q: "料金体系はどうなっていますか？",
    a: "月額固定制のサブスクリプション型です。クリニックの規模や必要機能に応じたプランをご用意しています。詳細はお問い合わせください。",
  },
  {
    q: "効果が出なかった場合はどうなりますか？",
    a: "導入後3ヶ月間は専任のカスタマーサクセスが月次で改善提案を行います。それでも効果が出ない場合は、個別に状況を確認し対応策をご提案します。",
  },
];
