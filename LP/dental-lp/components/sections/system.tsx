  ...
  return (
    <div className="w-[280px] bg-white rounded-[3rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border-[8px] border-gray-900 relative overflow-hidden h-[480px] flex flex-col shrink-0">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50 p-3 pt-8 flex flex-col gap-3 relative z-10">
        <div className="w-full rounded-xl overflow-hidden shadow-sm">
          <img src="/uploads/app-1.jpg" alt="App Screen 1" className="w-full h-auto blur-[0.5px] opacity-100 object-cover" />
        </div>
        <div className="w-full rounded-xl overflow-hidden shadow-sm">
          <img src="/uploads/app-2.jpg" alt="App Screen 2" className="w-full h-auto blur-[0.5px] opacity-100 object-cover" />
        </div>
        <div className="w-full rounded-xl overflow-hidden shadow-sm">
          <img src="/uploads/app-3.jpg" alt="App Screen 3" className="w-full h-auto blur-[0.5px] opacity-100 object-cover" />
        </div>
        <div className="w-full rounded-xl overflow-hidden shadow-sm">
          <img src="/uploads/app-4.jpg" alt="App Screen 4" className="w-full h-auto blur-[0.5px] opacity-100 object-cover" />
        </div>
      </div>
    </div>
  );
